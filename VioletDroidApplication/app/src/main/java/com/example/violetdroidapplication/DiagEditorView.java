...
/**
 * Created by aniquedavla on 12/1/16.
 *
 * A View to be used inside an Activity
 * This View will be used as the main editor for Class Diagrams
 */

public abstract class DiagEditorView extends View{

        public static final String ITEMS_KEY = "items";
        private static final String FILE_TYPE = "diagram";
        private static final String TAG = "DiagEditorView";
         ...
         */
        public DiagEditorView(Context context) {this(context, null);}
         ...
         */
        public DiagEditorView(Context ctx, AttributeSet attrs) {
            super(ctx, attrs);
